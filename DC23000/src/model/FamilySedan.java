...
public class FamilySedan extends Vehicle {
	...
	public FamilySedan() {
		...
		super(SEDAN_SIZE, SEDAN_MIN_CAPACITY, SEDAN_MAX_CAPACITY, SEDAN_SHOP_PROBABILITY, SEDAN_TICKS_BEFORE_SHOP,
				SEDAN_MIN_SHOP_TICKS, SEDAN_MAX_SHOP_TICKS, SEDAN_MIN_SHOP_SPEND, SEDAN_MAX_SHOP_SPEND);
