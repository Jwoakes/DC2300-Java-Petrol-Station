...
import javafx.beans.property.SimpleIntegerProperty;
    ...
    public class PetrolStation {
    	 ...
    	 * @param smallestVehicle the smallest size a vehicle can be
    	 * @param maxQueueSize the maximum size a queue can be
    	 */
    	...
    	/**
    	 * Passes a Customer to the Shop or the Till Controller depending upon their preference
    	 ...
    	 * @param customers customers at the petrol station
    	 */
