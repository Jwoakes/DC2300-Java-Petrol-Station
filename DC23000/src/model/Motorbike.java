...
public class Motorbike extends Vehicle {
	 ...
	 */
	public Motorbike() {
		super(MOTORBIKE_SIZE, MOTORBIKE_MIN_CAPACITY, MOTORBIKE_MAX_CAPACITY, MOTORBIKE_SHOP_PROBABILITY,
				MOTORBIKE_TICKS_BEFORE_SHOP, MOTORBIKE_MIN_SHOP_TICKS, MOTORBIKE_MAX_SHOP_TICKS,
				MOTORBIKE_MIN_SHOP_SPEND, MOTORBIKE_MAX_SHOP_SPEND);
	}
